 ...
 * @author EddyReyes
 */
public class AgregarActividadIndividual extends javax.swing.JFrame {
    ...
    public AgregarActividadIndividual(JLabel contador, DefaultTableModel modeloActividades, DefaultTableModel modeloEstudiantes, int carnet, JComboBox combobox) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Agregar Actividad Individual");
        ...
        try {
            ...
            if (lugar.trim().equals("") || actividadRealizada.trim().equals("") || fecha.equals("")) {
                ...
                if (jRadioButton1.isSelected()) {
                    float totalDeHoras = Float.valueOf(jTextField1.getText());
                    conexion.ingresarActividad(fecha, lugar, totalDeHoras, carnet, actividadRealizada);
                    ...
                    if (horaI < 24 && horaF <= 24 && minutosI < 60 && minutosF < 60) {
                        if (horaF == 24 && minutosF == 0 || horaF < 24) {
                            conexion.ingresarActividad(fecha, lugar, horaInicio, horaFin, carnet, actividadRealizada);
                            actualizarListadoActividades();
                            actualizarListadoEstudiantes(combobox.getSelectedIndex());
                            JOptionPane.showMessageDialog(rootPane, "Actividad registrada correctamente");
                            this.dispose();
